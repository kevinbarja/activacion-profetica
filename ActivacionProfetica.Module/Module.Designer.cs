namespace ActivacionProfetica.Module {
	partial class ActivacionProfeticaModule {
		/// <summary> 
		...
		/// </summary>
		/// <param singularName="disposing">true if managed resources should be disposed; otherwise, false.</param>
